...
import uz.gita.dima.mobile_banking.data.remote.api.UserApi
...
import uz.gita.dima.mobile_banking.domain.repository.UserRepository
...
class UserRepositoryImpl @Inject constructor(
    ...
    override fun getUserDetail(): Flow<ResultData<UserData>> = flow {
